...
begin
    ...
    exp_jinput_3 = JumpInputs(exp_chain, u0, tspan, ps4)
end
...
begin
    ...
    cov_out_4 = timeseries_point_meancov(exp_sol_4, ts, ts)

    ts2= t0:1.0:tf
    all_As_4 = [componentwise_vectors_timepoint(exp_sol_4, i)[1] for i in collect(ts2)]
    all_Bs_4 = [componentwise_vectors_timepoint(exp_sol_4, i)[2] for i in collect(ts2)]
end

begin
    jldsave("ExpoSim_4_raw_full.jld2"; ts, cov_out_4, ts2, all_As_4, all_Bs_4)
end
